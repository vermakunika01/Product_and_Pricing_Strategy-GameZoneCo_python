# Product & Pricing Strategy - GameZone Co
GameZone Co. is an e-commerce gaming company. We are solving one key Business Problem Statement for the Executive team:  
**How can we improve the effectiveness of our sales and marketing efforts across marketing channels, products, and countries, based on customer behavior and transaction patterns?**

## Project Scope and Dataset Overview

### Dataset Highlights: 
- Data of purchase transactions from Gamezone.co
- Covers 2019–2021 (3-year window)
- Includes 20,000+ entries across:
    - Products purchased
    - Purchase & shipping dates
    - Platforms and marketing channels
    - Country of purchase
 
### Objective of this analysis: 
- This analysis is designed to equip teams develop a tailored plan that caters to audience’s evolving demands real-time. 
- It aims to support decision-making across:
  - The **executive** team: with high-level trends and growth opportunities
  - The **marketing** team: by identifying top-performing channels and timing
...
- Data Cleaning and Preparation (a log file was created for the same):
    ...
    - Checked consistency in terms of business logic
    - Fixed missing values
- Identified the limitations/ assumptions to keep in mind
- Exploratory Analysis (Python: numpy and pandas)
...
- Before deep diving into the analysis, real work begins with:
  ...
  - identifying the **stakeholders** that could leverage the outcome of the analysis
  - understanding what each team considers a **'successful metric outcome'**
